...
function CategoryButton({chosenCategory,categoryName,setChosenCategory,setIsChosenCategory}) {
    ...
    var btnClass = classNames(classes.button, {[`${classes.selectedButton}`] : isSelected});
    return (
        <div 
          className={btnClass}
            color="secondary"
