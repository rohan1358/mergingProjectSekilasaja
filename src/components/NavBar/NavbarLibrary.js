...
export default function NavBarLibrary(props) {
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem>
        <Link href="/accounts" underline="none" className={classes.link}>
          Account
        </Link>
      </MenuItem>
      <MenuItem>
        <Link underline="none" className={classes.link} onClick={() => fire.auth().signOut()}>
            Log out
        </Link>
      </MenuItem>
    </Menu>
        ...
        <Container>
          <Toolbar>
            ...
            <div className={desktopClass}>
              ...
              <Button href="/accounts" round color="transparent">
                Account
              </Button>
